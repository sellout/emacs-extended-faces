...
(custom-theme-set-faces
 ...
 '(secondary-selection
   ((((class color) (min-colors 88) (background light))
     (:extend t :background "yellow1"))
    (((class color) (min-colors 88) (background dark))
     (:extend t :background "SkyBlue4"))
    (((class color) (min-colors 16) (background light))
     (:extend t :background "yellow"))
    (((class color) (min-colors 16) (background dark))
     (:extend t :background "SkyBlue4"))
    (((class color) (min-colors 8))
     (:extend t :foreground "black" :background "cyan"))
    (t (:inverse-video t))))
 '(trailing-whitespace
 ...
 '(nobreak-space
   ((((class color) (min-colors 88))
     (:underline (:color foreground-color :style line) :inherit (escape-glyph)))
 ...
 '(mode-line-inactive
   ((default (:inherit (mode-line)))
    (((class color) (min-colors 88) (background light))
     ( :background "grey90"
       :foreground "grey20"
       :box (:line-width (1 . -1) :color "grey75" :style nil)
       :weight light))
    (((class color) (min-colors 88) (background dark))
     ( :background "grey30"
       :foreground "grey80"
       :box (:line-width (1 . -1) :color "grey40" :style nil)
       :weight light))))
 '(mode-line-highlight
 ...
 '(tab-bar
   ((((class color) (min-colors 88))
     (:foreground "black" :background "grey85" :inherit (variable-pitch)))
 ...
 '(help-key-binding
   ((((class color) (min-colors 88) (background light))
     ( :box (:line-width (1 . -1) :color "grey80" :style nil)
       :foreground "DarkBlue"
       :background "grey96"))
    (((class color) (min-colors 88) (background dark))
     ( :box (:line-width (1 . -1) :color "grey35" :style nil)
 ...
 '(tty-menu-disabled-face
   ((((class color) (min-colors 16))
     (:background "blue" :foreground "lightgray"))
 ...
 '(isearch-group-1
   ((((class color) (min-colors 88) (background light))
     (:foreground "lightskyblue1" :background "#f000f0"))
    (((class color) (min-colors 88) (background dark))
     (:foreground "brown4" :background "palevioletred1"))
    (t (:inherit (isearch)))))
 '(isearch-group-2
   ((((class color) (min-colors 88) (background light))
     (:foreground "lightskyblue1" :background "#a000a0"))
    (((class color) (min-colors 88) (background dark))
     (:foreground "brown4" :background "palevioletred3"))
    (t (:inherit (isearch)))))
 '(file-name-shadow
   ((t (:inherit (shadow)))))
 '(tab-bar-tab
 ...
 '(widget-field
   ((((type tty)) (:extend t :foreground "black" :background "yellow3"))
    (((class grayscale color) (background light))
     (:extend t :background "gray85"))
    (((class grayscale color) (background dark))
     (:extend t :background "dim gray"))
 ...
 '(custom-button-pressed
   ((((type x w32 ns) (class color))
     ( :foreground "black"
       :background "lightgrey"
       :box (:line-width (2 . 2) :color nil :style pressed-button)))
    (t (:inverse-video t))))
